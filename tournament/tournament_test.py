...
# --- PLEASE NOTE ---
#    I changed the function names in this file to use lowercase rather than to
#    use camelcase which we were urged not to do in the first course of this
#    Nanodegree. The functions are all identical except by name to satisfy
